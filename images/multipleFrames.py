...
leftFrame = Frame(root, width=200, height = 600, bg='green')
leftFrame.grid(row=0, column=0, padx=10, pady=2)

Label(leftFrame, text="Instructions:", bg='blue').grid(row=0, column=0, padx=10, pady=2)
